...
After completing all of this our team could finally turn to the F3 requirements, and as we where satisfied with the game play; the requirements where a bit less complected to add on.
